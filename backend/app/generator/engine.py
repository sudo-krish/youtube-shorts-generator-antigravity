...
from .capabilities.text.overlays import run_whisperx
...
def _build_visual_filtergraph(
    ...
    if focus_keyframes:
        from app.generator.capabilities.transformations.hyperframe import generate_polynomial_from_keyframes
