    ...
    def _generate_deepseek(self, model: str, contents: list, config: types.GenerateContentConfig = None):
        ...
        try:
            if hasattr(response, 'usage') and response.usage:
                ...
                model_id = db.models.get_or_create("deepseek", model)
                db.models.log_usage(model_id, prompt_tokens, completion_tokens, cost)
        except Exception as e:
    ...
    def generate_content(
        ...
        try:
            ...
            if (
                ...
                try:
                    model_id = db.models.get_or_create("gemini", model)
                    db.models.log_rate_limit(model_id, str(actual_error))
                except Exception:
                    pass
            else:
                try:
