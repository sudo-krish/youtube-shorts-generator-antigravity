...
class VideoPhase(BaseModel):
    ...
    start_focus_x: float = Field(default=960.0, description="The spatial X coordinate (0-1920) for the primary action at the START of this phase.")
    end_focus_x: float = Field(default=960.0, description="The spatial X coordinate (0-1920) for the primary action at the END of this phase.")
...
class ViralShortBlueprint(BaseModel):
    ...
    background_audio_track: str = Field(default="bgm.mp3", description="The filename of the semantic audio track selected to score this video.")
